...
fn main() -> Result<()> {
    ...
    let mut canvas = Canvas::builder()
        ...
        // .debug(true) // Enable debug mode - disabled
        .build()?;
    ...
    layer1.draw_text("مرحباً بكم في Clove2d!")
        .font_family("Tajawal")
        .font_size(20.0)
    ...
    layer2.draw_text("مرحباً بكم في Clove2d!")
        .font_family("Cairo")
        .font_size(20.0)
    ...
    layer3.draw_text("مرحباً بكم في Clove2d!")
        .font_family("NotoSansArabic")
        .font_size(20.0)
    ...
    layer4.draw_text("مرحباً بكم في Clove2d!")
        .font_family("Almarai")
        .font_size(20.0)
    ...
    canvas.save("saves/text-arabic-debug.png")?;
    Ok(())
}
